...
export default function ProductList() {
  ...
  return (
    <div>
      ...
      <ProductModalForm product={updateProduct} show={showModal} onHide={handleFormClose} />
          ...
          {productList.map((product) => (
            <tr key={product.id} className=''>
              ...
              <td className='text-center'>
                ...
                <Button variant='danger' className='btn-quantity ' onClick={() => { handleDelete(product.id) }}  ><i className="bi bi-trash3"></i></Button>
              </td>
